...
class RDBVal extends TermBase
    ...
    between: (left, right, opts) -> new Between opts, @, left, right
    ...
    do: (args...) -> new FunCall {}, @, args.map(funcWrap)...
...
rethinkdb.args = varar 0, null, (args...) -> new Args {}, args...
